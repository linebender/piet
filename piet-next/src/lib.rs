...
pub use generic_record::GenericRecorder;
...
pub trait RenderCtx {
    ...
    fn stroke(&mut self, path: &Path, stroke: &Stroke, brush: BrushRef);
    ...
    fn draw_glyphs(&mut self, style: StyleRef, glyphs: &dyn Iterator<Item = Glyph>);
